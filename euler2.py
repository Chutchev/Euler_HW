...
def diff():
    numbers = [i for i in range(1, 101)]  # Генератор списка
    sum_of_square = sum(map(lambda i: i**2, numbers))  # Есть и мар и лямбда
...
71636269561882670428252483600823257530420752963450"""
    ...
    for i in range(len(n)-4):
        op = int(n[i])*int(n[i+1])*int(n[i+2])*int(n[i+3])*int(n[i+4])
        if op > max:
            max = op
    return max
